...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_17_03/t1.small.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_17_03/c1.small.x86
kernel ${base-url}/kernel init=/nix/store/a8nhjab9brxw80lnvrpxj37wkgmxa0bl-nixos-system-ipxe-17.03.945.5acb454e2a/init initrd=initrd console=ttyS1,115200 loglevel=7
initrd ${base-url}/initrd
boot
`,
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_17_03/m1.xlarge.x86
kernel ${base-url}/kernel init=/nix/store/a8nhjab9brxw80lnvrpxj37wkgmxa0bl-nixos-system-ipxe-17.03.945.5acb454e2a/init initrd=initrd console=ttyS1,115200 loglevel=7
initrd ${base-url}/initrd
boot
`,
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_17_03/c1.xlarge.x86
kernel ${base-url}/kernel init=/nix/store/a8nhjab9brxw80lnvrpxj37wkgmxa0bl-nixos-system-ipxe-17.03.945.5acb454e2a/init initrd=initrd console=ttyS1,115200 loglevel=7
initrd ${base-url}/initrd
boot
`,
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/t1.small.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/c1.small.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/c2.medium.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/m1.xlarge.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/m2.xlarge.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/c1.xlarge.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/c1.large.arm
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/s1.large.x86
...
set base-url http://install.` + facility + `.packet.net/misc/boots/nixos/nixos_18_03/x1.small.x86
