...
// DeprecatedWatch mocks base method.
func (m *MockHardwareServiceClient) DeprecatedWatch(arg0 context.Context, arg1 *hardware.GetRequest, arg2 ...grpc.CallOption) (hardware.HardwareService_DeprecatedWatchClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DeprecatedWatch", varargs...)
	ret0, _ := ret[0].(hardware.HardwareService_DeprecatedWatchClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DeprecatedWatch indicates an expected call of DeprecatedWatch.
func (mr *MockHardwareServiceClientMockRecorder) DeprecatedWatch(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeprecatedWatch", reflect.TypeOf((*MockHardwareServiceClient)(nil).DeprecatedWatch), varargs...)
}
