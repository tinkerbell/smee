...
require (
	...
	github.com/tinkerbell/dhcp v0.0.0-20230405061318-d2278bbacf18
	github.com/tinkerbell/ipxedust v0.0.0-20230331160149-21f8cfc79fad
...
require (
	...
	github.com/tinkerbell/tink v0.8.0 // indirect
